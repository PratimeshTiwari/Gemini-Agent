...
import { prompt, clearPromptCache } from '../../src/core/prompt-loader.js';
import { PromptBuilder } from '../../src/core/prompt-builder.js';
import { EFFORT_LEVELS } from '../../src/core/effort.js';

// Relative to the *source* tree, not to this file: the tests live under
// server/test/ and the prompts ship next to the code that reads them.
const PROMPTS_DIR = path.join(path.dirname(fileURLToPath(import.meta.url)), '..', '..', 'src', 'prompts');
